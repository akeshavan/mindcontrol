...
Template.longitudinal_quality_metrics.rendered = function() {
      ...
      if (!this.rendered){
       ...
       this.autorun(function() {
                render_histogram("longitudinal_quality_metrics")
...
Template.longitudinal_quality_metrics.helpers({

selector: function(){return get_filter("longitudinal_quality_metrics")},



metric: function(){
        return get_metrics("longitudinal_quality_metrics")
    },
currentMetric: function(){
        return Session.get("current_longitudinal_quality_metrics")
    }
   ...
   Template.longitudinal_quality_metrics.events({
    "change #metric-select-longitudinal_quality_metrics": function(event, template){
        var metric = $(event.currentTarget).val()
        console.log("metric: ", metric)
        Session.set("current_longitudinal_quality_metrics", metric)
    }
   })
